# ATLAS_PUGUH Phase A — Nomad Deployment Quickstart

**TL;DR**: Deploy ATLAS_PUGUH ke VPS dengan Nomad dalam 15 menit
...
scp -r /mnt/f/WINDSURF/neliti_code/signate/ATLAS_PUGUH/nomad root@31.97.111.175:/root/atlas-puguh/

# Upload backend code (pilih salah satu):
# Option A: Upload all backend code
scp -r /mnt/f/WINDSURF/neliti_code/signate/ATLAS_PUGUH/backend root@31.97.111.175:/root/atlas-puguh/
...
# Access psql
docker exec -it <container-id> psql -U atlas_user -d atlas_puguh

# Check users
atlas_puguh=# SELECT username, role FROM users;
#  username | role
# ----------+---------
#  admin    | admin
#  approver | approver
