                  ...
                  <TableRow key={record.id}>
                    ...
                    <TableCell>
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => navigate(`/control/audit/${record.id}`)}
                      >
                        View
                      </Button>
                    </TableCell>
...
export function AuditDetail() {
  ...
  if (isLoading) {
    return (
      <DomainPage domain="control" title="Loading..." backTo="/control/audit">
        <Card>
  ...
  if (error || !record) {
    return (
      <DomainPage domain="control" title="Error" backTo="/control/audit">
        <Card>
                  ...
                  <TableRow key={event.id}>
                    ...
                    <TableCell>
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => navigate(`/control/events/${event.id}`)}
                      >
                        View
                      </Button>
                    </TableCell>
...
export function EventDetail() {
  ...
  if (isLoading) {
    return (
      <DomainPage domain="control" title="Loading..." backTo="/control/events">
  ...
  if (error || !event) {
    return (
      <DomainPage domain="control" title="Error" backTo="/control/events">
        <Card>
          <CardContent className="py-12 text-center text-red-500">
            <AlertCircle className="h-8 w-8 mx-auto mb-2" />
                  ...
                  <TableRow key={event.id}>
                    ...
                    <TableCell>
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => navigate(`/control/events/${event.originalEventId}`)}
                      >
                        View Original
                      </Button>
                    </TableCell>
