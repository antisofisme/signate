...
# Test it first
curl http://api-puguh.atlashub.com/health
```
...
```hcl
CORS_ORIGINS = "http://localhost:3000,http://127.0.0.1:3000,https://admin-puguh.atlashub.com"
```
...
**Fix**: Update to:
```hcl
CORS_ORIGINS = "http://localhost:3000,http://127.0.0.1:3000,http://localhost:5173,https://admin-puguh.atlashub.com"
```
