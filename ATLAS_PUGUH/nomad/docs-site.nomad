/**
 * ATLAS PUGUH - Documentation Site Nomad Job
...
job "puguh-docs" {
  ...
  meta {
    version = "1.0.0"
    description = "ATLAS PUGUH Documentation Site"
  }
  ...
  group "docs" {
    ...
    task "nginx" {
      ...
      config {
        ...
        volumes = [
          "/root/atlas-puguh/docs-site/build:/usr/share/nginx/html:ro",
...
EOF
      ...
      service {
        ...
        tags = [
          ...
          "puguh",
          "traefik.enable=true",
          "traefik.http.routers.puguh-docs.rule=Host(`docs.puguh.atlashub.com`)",
