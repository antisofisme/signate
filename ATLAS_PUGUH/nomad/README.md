# ATLAS_PUGUH - Nomad Deployment Files
...
- **Traefik Routing**: Auto-discovered, routed to `api-puguh.atlashub.com`
...
nomad alloc exec -namespace=puguh $BACKEND_ALLOC \
  psql -h puguh-postgres.service.consul -p 5433 -U atlas_user -d atlas_puguh
```
