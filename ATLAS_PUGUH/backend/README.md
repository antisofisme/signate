...
ATLAS_PUGUH Core Service provides:
...
# 3. Run migrations
psql -h localhost -p 5433 -U atlas_user -d atlas_puguh < migrations/001_initial_schema.sql
psql -h localhost -p 5433 -U atlas_user -d atlas_puguh < migrations/002_immutability_triggers.sql
psql -h localhost -p 5433 -U atlas_user -d atlas_puguh < migrations/003_rls_policies.sql
psql -h localhost -p 5433 -U atlas_user -d atlas_puguh < migrations/seed_phase_a.sql
...
```bash
# Database
DATABASE_URL=postgresql+asyncpg://atlas_user:PASSWORD@localhost:5433/atlas_puguh
...
# Test connection
psql -h localhost -p 5433 -U atlas_user -d atlas_puguh -c "SELECT 1"
