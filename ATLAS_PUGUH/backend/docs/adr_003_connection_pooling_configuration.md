...
The ATLAS_PUGUH Core Service uses PostgreSQL as the authoritative data store. Each API request typically requires 1-3 database queries (authentication, rule fetching, decision logging). Without connection pooling:
