#!/bin/bash
# ============================================================================
# ATLAS_PUGUH Phase A - Run Database Migrations
# ============================================================================
...
echo ""
echo "============================================================================"
echo "  ATLAS_PUGUH Phase A - Database Migration"
echo "============================================================================"
echo ""
...
#
# Custom host/port:
#   POSTGRES_PASSWORD=your_password ./run_migrations.sh 192.168.1.100 5432 atlas_puguh
#
# Via Docker container:
#   docker exec -i <container-id> psql -U atlas_user -d atlas_puguh < 001_initial_schema.sql
#
# ============================================================================
