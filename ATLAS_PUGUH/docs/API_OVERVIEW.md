# ATLAS_PUGUH API Overview

Complete API documentation for the ATLAS_PUGUH SaaS platform.

## Base URLs

| Environment | URL |
|-------------|-----|
| Production | `https://api-puguh.atlashub.com` |
| Staging | `https://api-puguh-staging.atlashub.com` |
...
```typescript
import { AtlasPuguhClient } from '@atlashub/puguh-sdk'

const client = new AtlasPuguhClient({
  baseUrl: 'https://api-puguh.atlashub.com',
...
client = Client(
    base_url="https://api-puguh.atlashub.com",
