# ATLAS_PUGUH User Guide

Welcome to ATLAS_PUGUH - the Constitutional Law System for AI Decisions.
...
2. Authorize ATLAS_PUGUH to access your account
...
- **Documentation**: `/docs`
- **API Status**: `/health`
- **Support Email**: support@atlashub.com
- **GitHub Issues**: [Report bugs](https://github.com/atlashub/atlas-puguh/issues)
