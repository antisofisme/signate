# 🧪 ATLAS_PUGUH Phase A+ - Testing Guide
...
# Check database
docker exec postgresql-1f85ac2c-3200-7c4a-6af6-c8802fa6b6e2 psql -U atlas_user -d atlas_puguh -c "SELECT COUNT(*) FROM decisions;"
```

**Solution**: Re-run insert script:
```bash
docker exec -i postgresql-1f85ac2c-3200-7c4a-6af6-c8802fa6b6e2 psql -U atlas_user -d atlas_puguh < /tmp/insert_test_data_correct.sql
```
...
```
ATLAS_PUGUH Phase A+ - Test Results
Date: ___________
Tester: ___________
