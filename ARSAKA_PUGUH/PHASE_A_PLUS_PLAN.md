...
**Standards**: Follow ARSAKA_PANDAWA docs conventions
...
## 📦 TECH STACK (Following ARSAKA_PANDAWA Standards)
...
### Directory Structure (Following ARSAKA_PANDAWA Convention)
```
frontend/
├── src/
...
3. **Build UI screens** - Following ARSAKA_PANDAWA patterns
