# ARSAKA_PUGUH - Constitutional Law System for AI Decisions
...
ARSAKA_PUGUH is a multi-tenant SaaS platform that provides:
...
Create `backend/.env`:
```env
DATABASE_URL=postgresql+asyncpg://user:pass@localhost:5432/arsaka_puguh
...
- **API Status**: `/health`
- **Support**: support@arsaka.io
- **Issues**: [GitHub Issues](https://github.com/arsaka/signate/issues)
