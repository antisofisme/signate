#!/bin/bash
# ARSAKA_PUGUH - Deploy Backend ke VPS
# Usage: ./deploy-backend-vps.sh

set -e  # Exit on error

echo "=========================================="
echo "ARSAKA_PUGUH - Backend Deployment to VPS"
echo "=========================================="
echo ""
...
VPS_USER="root"
IMAGE_NAME="arsaka-puguh-backend"
IMAGE_TAG="phase-a"
NAMESPACE="puguh"
...
sed -i 's|image = "python:3.11-slim"|image = "arsaka-puguh-backend:phase-a"|' /tmp/backend-api.nomad
