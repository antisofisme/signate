# ARSAKA_PUGUH Deployment Checklist
...
```env
# Database
DATABASE_URL=postgresql+asyncpg://user:pass@host:5432/arsaka_puguh
...
# CORS
CORS_ORIGINS=https://puguh.arsaka.io
```
...
rsync -avz dist/ deploy@vps:/opt/arsaka_puguh/frontend/
...
| Role | Contact |
|------|---------|
| DevOps Lead | devops@arsaka.io |
| Backend Lead | backend@arsaka.io |
| Database Admin | dba@arsaka.io |
| Security Team | security@arsaka.io |
