#!/bin/bash
# ============================================================================
# ARSAKA_PUGUH Phase A - VPS Upload Script
# ============================================================================
...
mkdir -p /root/arsaka-puguh/backend
mkdir -p /root/arsaka-puguh/nomad
...
display_next_steps() {
    ...
    echo -e "   ${BLUE}docker exec -i <container-id> psql -U atlas_user -d arsaka_puguh < ${VPS_DEST}/backend/migrations/001_initial_schema.sql${NC}"
    echo -e "   ${BLUE}docker exec -i <container-id> psql -U atlas_user -d arsaka_puguh < ${VPS_DEST}/backend/migrations/002_immutability_triggers.sql${NC}"
    echo -e "   ${BLUE}docker exec -i <container-id> psql -U atlas_user -d arsaka_puguh < ${VPS_DEST}/backend/migrations/003_rls_policies.sql${NC}"
    echo -e "   ${BLUE}docker exec -i <container-id> psql -U atlas_user -d arsaka_puguh < ${VPS_DEST}/backend/migrations/seed_phase_a.sql${NC}"
    echo ""
...
main() {
    echo ""
    echo "============================================================================"
    echo "  ARSAKA_PUGUH Phase A - VPS Upload"
    echo "============================================================================"
    echo ""
