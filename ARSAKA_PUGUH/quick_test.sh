#!/bin/bash
# ARSAKA_PUGUH Phase A+ - Quick Test Script
...
echo "=========================================="
echo "🧪 ARSAKA_PUGUH Phase A+ - Quick Test"
echo "=========================================="
echo ""
...
if [ "$DECISION_COUNT" -ge 5 ]; then
  ...
  echo "   ℹ️  Run: ssh root@31.97.111.175 'docker exec -i postgresql-1f85ac2c-3200-7c4a-6af6-c8802fa6b6e2 psql -U atlas_user -d arsaka_puguh < /tmp/insert_test_data_correct.sql'"
fi
echo ""
