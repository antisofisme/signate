...
- **Traefik**: `http://api.puguh.arsaka.io` (if Traefik running)
...
- Backend should be accessed via **Traefik** (`api.puguh.arsaka.io`) OR **Consul DNS** (`puguh-backend.service.consul:8001`)
...
All 5 screens have been built following ARSAKA_PANDAWA standards with:
