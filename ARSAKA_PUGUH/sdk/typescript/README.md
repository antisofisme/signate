...
TypeScript client library for ARSAKA_PUGUH Core Service decision engine and workflow orchestration.

## Installation

```bash
npm install @arsaka-puguh/core-service-sdk
```

Or with yarn:

```bash
yarn add @arsaka-puguh/core-service-sdk
```
...
import {
  ...
  NetworkError,
  CoreServiceError
} from '@arsaka-puguh/core-service-sdk';
