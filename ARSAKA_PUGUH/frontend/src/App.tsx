/**
 * ARSAKA_PUGUH Frontend - SaaS Platform
...
// Billing Pages
import { PricingPage, BillingSettingsPage, InvoicesPage, PaymentSuccessPage } from '@/pages/billing'

// Project Feature
import { ProjectListPage, ProjectSettingsPage, ProjectMembersPage } from '@/features/project'

// Product Switcher
import ProductSwitcher from '@/pages/products/ProductSwitcher'

// Account & Security
import { SecurityDashboard } from '@/features/account'
      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            <Route path="decision/rules/:id/edit" element={<EditRule />} />
            ...
            <Route path="workflow/:id/delegate" element={<WorkflowDelegate />} />
            ...
            {/* ============================================ */}
            <Route path="products" element={<ProductSwitcher />} />

            {/* ============================================ */}
            {/* Account & Settings Routes */}
            {/* ============================================ */}
            <Route path="settings" element={<AccountSettings />} />
            <Route path="account/security" element={<SecurityDashboard />} />
            ...
            <Route path=":tenantSlug/:projectSlug/members" element={<ProjectMembersPage />} />
