...
See the latest actions across your tenant.
    ...
    docsUrl: 'https://docs.puguh.arsaka.io/docs/',
    priority: 100,
  },
...
- Deprecated: Being phased out
    ...
    docsUrl: 'https://docs.puguh.arsaka.io/docs/getting-started/first-rule',
    priority: 90,
  },
  {
    id: 'rule-conditions',
...
\`amount > 1000 AND department = "sales"\`
    ...
    docsUrl: 'https://docs.puguh.arsaka.io/docs/user-guides/decisions/rule-builder',
    priority: 80,
  },
  {
    id: 'rule-versioning',
...
- Use staging projects for experiments
    ...
    docsUrl: 'https://docs.puguh.arsaka.io/docs/user-guides/decisions/versioning',
    priority: 70,
  },
...
- Escalate: Move to supervisor
    ...
    docsUrl: 'https://docs.puguh.arsaka.io/docs/user-guides/workflows/creating',
    priority: 90,
  },
  {
...
Set triggers when creating rules or via the workflow builder.
    ...
    docsUrl: 'https://docs.puguh.arsaka.io/docs/user-guides/workflows/triggers',
    priority: 80,
  },
...
Managed via Roles assigned to users.
    ...
    docsUrl: 'https://docs.puguh.arsaka.io/docs/user-guides/iam/users',
    priority: 90,
  },
  {
    id: 'iam-roles',
...
Example: \`decision.rules.create\`
    ...
    docsUrl: 'https://docs.puguh.arsaka.io/docs/user-guides/iam/roles',
    priority: 85,
  },
...
Use the tenant selector in the header to switch between organizations you belong to.
    ...
    docsUrl: 'https://docs.puguh.arsaka.io/docs/getting-started/first-tenant',
    priority: 90,
  },
  {
    id: 'tenant-members',
...
- Viewer: Read-only
    ...
    docsUrl: 'https://docs.puguh.arsaka.io/docs/getting-started/first-tenant#inviting-team-members',
    priority: 85,
  },
...
Depends on your plan (7 days to 1 year+).
    ...
    docsUrl: 'https://docs.puguh.arsaka.io/docs/user-guides/control/environments',
    priority: 90,
  },
  {
    id: 'event-timeline',
...
- Monitor system health
    ...
    docsUrl: 'https://docs.puguh.arsaka.io/docs/user-guides/control/deployment',
    priority: 80,
  },
