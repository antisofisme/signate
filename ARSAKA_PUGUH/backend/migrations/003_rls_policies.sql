...
GRANT SELECT, INSERT ON schema_migrations TO infra_core_app;
...
COMMENT ON ROLE infra_core_app IS
  'Application role for ARSAKA_PUGUH Core service - limited to SELECT and INSERT on immutable tables';
