...
Orchestrates workflow rejection.
...
class RejectWorkflowUseCase:
    ...
    async def execute(self, input_dto: RejectWorkflowInput) -> RejectWorkflowOutput:
        """
        Execute workflow rejection
        """
