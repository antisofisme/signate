...
**Project**: ARSAKA_PUGUH Core Service
...
sshpass -p '1(;2-Ur?F)PP73J#G-wW' rsync -avz \
  ...
  /mnt/f/WINDSURF/neliti_code/signate/ARSAKA_PUGUH/ \
  root@72.61.209.158:/root/arsaka_puguh/

# 2. Start services on VPS
sshpass -p '1(;2-Ur?F)PP73J#G-wW' ssh root@72.61.209.158 \
  "cd /root/arsaka_puguh && docker-compose up -d"

# 3. Execute load tests remotely
sshpass -p '1(;2-Ur?F)PP73J#G-wW' ssh root@72.61.209.158 \
  "cd /root/arsaka_puguh/backend && locust ..."

# 4. Transfer results back
sshpass -p '1(;2-Ur?F)PP73J#G-wW' scp -r \
  root@72.61.209.158:/root/arsaka_puguh/backend/load_test_results/ \
