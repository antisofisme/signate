...
Docker Image:   arsaka-puguh-backend:phase-a
```
...
### Docker Image
**Name**: `arsaka-puguh-backend:phase-a`
...
### 1. `/root/arsaka-puguh/nomad/backend-api-fixed.nomad`
...
env {
  DATABASE_URL = "postgresql+asyncpg://atlas_user:TBBQrXTZezvF8cybncpno686lSDA9_E6@puguh-postgres.service.consul:5433/arsaka_puguh"
  JWT_SECRET_KEY = "JAFpjBZvSyc57V1IIG_z5ZyAAnhHRd1swKaip8VfGVE"
  # ... all other env vars ...
}
```

### 2. `/root/arsaka-puguh/backend/core/repositories/models.py`
...
### Local Files
1. `/mnt/f/WINDSURF/neliti_code/signate/ARSAKA_PUGUH/backend/core/repositories/models.py`
...
### Docker Images
1. `arsaka-puguh-backend:phase-a`
