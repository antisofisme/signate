...
This document defines the **conceptual model** for ARSAKA_PANDAWA with practical examples. It explains the core relationships between Users, Tenants, Applications, Roles, and Memberships.
...
**Definition**: A complete, isolated business entity operating within ARSAKA_PANDAWA.
