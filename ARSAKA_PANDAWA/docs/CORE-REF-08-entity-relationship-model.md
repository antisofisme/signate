...
This document defines the **logical and conceptual entity relationship model** for ARSAKA_PANDAWA. It shows the structure of data entities, their attributes, and relationships across all business domains.
