...
This document establishes the **architectural principles for module design, module boundaries, and module composition** in ARSAKA_PANDAWA. It defines how modules can be technically standalone but strategically bundled as products.
