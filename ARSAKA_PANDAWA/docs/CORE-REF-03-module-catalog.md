...
This document is the **definitive inventory of all modules** in ARSAKA_PANDAWA. It specifies each module's role, architectural classification, subscription model, and dependencies.
