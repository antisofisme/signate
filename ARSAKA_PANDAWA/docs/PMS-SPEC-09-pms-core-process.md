...
This document specifies the **core operational workflow** of the PMS (Property Management System) module in ARSAKA_PANDAWA. It defines the business process for guest reservations, check-in/check-out, in-house operations, and daily closing (night audit).
