...
This document specifies how tenants establish formal business relationships and grant cross-tenant access through **BusinessContract** entities. Contracts are the ONLY mechanism for data sharing between tenants in ARSAKA_PANDAWA.
