...
Multi-tenancy memungkinkan satu instance aplikasi melayani banyak tenant (organization) dengan data isolation yang proper. ARSAKA_PANDAWA menggunakan **Row-Level Isolation** sebagai primary approach.
