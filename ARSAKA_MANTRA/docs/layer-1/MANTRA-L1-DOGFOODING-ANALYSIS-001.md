...
The following decisions appear to have been made during ARSAKA_MANTRA development but are NOT formally recorded in the decision database. Each requires human review and formal recording.
...
- `ambiguity`: Scope unclear - does this apply to ALL display layers or only ARSAKA_MANTRA UI?
