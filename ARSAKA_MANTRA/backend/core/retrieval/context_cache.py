...
class HotDecisionsCache:
    ...
    def get_hot_decisions(self, limit: int = 10) -> List[Dict[str, Any]]:
        """
        Get the most frequently accessed (hot) decisions.

        Args:
            limit: Maximum number of decisions to return

        Returns:
            List of decision dictionaries sorted by access count (descending)
        """
        with self._lock:
