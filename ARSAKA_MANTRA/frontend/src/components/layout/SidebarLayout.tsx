      ...
      <header className={clsx(
        ...
        <div className="flex h-14 items-center px-4 gap-4">
          ...
          <div className="flex items-center gap-2 text-white">
            <span className="font-bold text-lg">ARSAKA_MANTRA</span>
        ...
        <aside className={clsx(
          ...
          <nav className="p-4 space-y-1 overflow-y-auto h-[calc(100%-4rem)] lg:h-[calc(100%-4rem)]">
            ...
            <NavLink
              ...
              title="Usage analytics and decision health tracking"
            >
              <Icons.Activity />
              <span>Analytics</span>
            </NavLink>
            ...
            <NavLink
              ...
              title="Generate documentation from MANTRA decisions"
            >
              <Icons.Changes />
            ...
            <NavLink
              ...
              title="Test context-aware decision retrieval"
            >
              <Icons.Search />
