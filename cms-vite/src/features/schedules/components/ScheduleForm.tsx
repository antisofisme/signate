    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
      ...
      {recurrenceType !== 'once' && (
        <div className="space-y-3">
          <h3 className="text-lg font-semibold text-gray-900">Exception Dates</h3>
                ...
                className={`
                  ...
                  ${
                    selected
                      ...
                      : `border-gray-200 bg-white hover:border-${priority.color}-300`
                  }
      ...
      <div className="flex items-center justify-between p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        <div>
          <h4 className="text-sm font-semibold text-yellow-900">Check for Conflicts</h4>
