...
export const SchedulePriorityManager = ({
  ...
  const conflictAnalysis = useMemo(() => {
    ...
    relatedSchedules.forEach((schedule) => {
      ...
      // Note: priority is optional, default to 'normal' (50)
      const priorityMap: Record<string, number> = { low: 25, normal: 50, high: 75, critical: 100 }
      const scheduleAny = schedule as Schedule & { priority?: string }
      const schedulePriority = priorityMap[scheduleAny.priority || 'normal'] || 50
