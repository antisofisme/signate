...
export default function TagStatsCard({ tag }) {
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700">
      {/* Header */}
      <div className="flex items-center gap-3 mb-4 pb-3 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-bold text-gray-800 dark:text-gray-100 text-lg truncate">{tag.tag_name}</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400 truncate">Statistics Overview</p>
        </div>
      </div>
      ...
      {!isLoading && (
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-gray-800 dark:text-gray-100">Devices</span>
              </div>
              <span className="text-2xl font-bold text-gray-800 dark:text-gray-100">{totalDevices}</span>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-500 dark:text-gray-400">({onlinePercentage}%)</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-semibold text-gray-700 dark:text-gray-300">{offlineDevices}</span>
                  <span className="text-xs text-gray-500 dark:text-gray-400">({100 - onlinePercentage}%)</span>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700 opacity-60">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700 opacity-60">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-gray-800 dark:text-gray-100">Playlists</span>
              </div>
              <span className="text-2xl font-bold text-gray-400 dark:text-gray-500">-</span>
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400">
