...
This document defines the architectural boundaries for the four API types in PROJECT_BESAR: Public, Internal, Partner, and Event. These boundaries prevent data leakage, enforce tenant isolation, and ensure clean module separation.
