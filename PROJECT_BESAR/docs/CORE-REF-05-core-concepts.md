...
This document defines the **conceptual model** for PROJECT_BESAR with practical examples. It explains the core relationships between Users, Tenants, Applications, Roles, and Memberships.
...
**Definition**: A complete, isolated business entity operating within PROJECT_BESAR.
