...
This document defines the **foundational identity and access control model** for PROJECT_BESAR. It is the authoritative source for how users, tenants, roles, and permissions relate.
...
**What it is**: A complete, isolated business operating within PROJECT_BESAR.
