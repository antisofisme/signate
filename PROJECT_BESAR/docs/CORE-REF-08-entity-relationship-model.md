...
This document defines the **logical and conceptual entity relationship model** for PROJECT_BESAR. It shows the structure of data entities, their attributes, and relationships across all business domains.
