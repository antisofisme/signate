 ...
 *
 * Features:
 * - Multiple variants: card, table, stats, grid, list, pending-approvals
 * - Animated pulse effect with smooth transitions
 * - Customizable count for repeating skeletons
 * - Responsive and accessible
 * - Fade-in animation support
 *
 * @param {string} variant - Type of skeleton (card, table, stats, grid, list, pending-approvals, custom)
