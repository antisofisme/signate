...
// =====================================================================
// MENU TYPE LABELS (Display names for menu types)
// =====================================================================
      ...
      <div class="menu-viewer menu-viewer--minimalist" style="${cssVars}">
        ...
        <header class="menu-viewer__header">
          <div class="menu-viewer__header-text">
            <h1 class="menu-viewer__title">${this.menu.name}</h1>
            ${this.menu.description ? `<p class="menu-viewer__description">${this.menu.description}</p>` : ''}
            ${this.menu.outlet_extension || this.menu.menu_type ? `
              <div class="menu-viewer__header-info">
                ${this.menu.menu_type ? `
                  <span class="menu-viewer__header-type">${getMenuTypeLabel(this.menu.menu_type)}</span>
                ` : ''}
                ${this.menu.menu_type && this.menu.outlet_extension ? `
                  <span class="menu-viewer__header-separator">•</span>
                ` : ''}
                ${this.menu.outlet_extension ? `
                  <span class="menu-viewer__header-ext">Ext. ${this.menu.outlet_extension}</span>
                ` : ''}
              </div>
            ` : ''}
          </div>
