-- ============================================================================
-- COMPLETE DATABASE SCHEMA FOR DIGITAL SIGNAGE SYSTEM (UPDATED)
-- Generated: 2024-11-11
-- This reflects the actual production database state including all applied migrations
-- ============================================================================
...
-- ============================================================================
-- 30. CONTENT PERFORMANCE TABLE (Analytics)
-- ============================================================================
...
-- ============================================================================
-- 31. DEVICE ENGAGEMENT TABLE (Analytics)
-- ============================================================================
...
-- ============================================================================
-- 32. DEVICE GROUP HIERARCHY TABLE
-- ============================================================================
...
-- Insert migration records for tracking
INSERT INTO schema_migrations (version) VALUES 
    ('001_complete_schema'),
    ('002_add_organization_fields'),
    ('003_create_contents_table'),
    ('004_create_tags_tables'),
    ('005_create_playlists_tables'),
    ('006_create_devices_table'),
    ('007_create_content_assignments_table'),
    ('008_create_device_support_tables'),
    ('009_add_roles_and_sessions'),
    ('010_add_device_logs_and_speed_tests'),
    ('011_add_content_playback_logs'),
    ('012_add_device_groups'),
    ('013_add_device_commands'),
    ('014_add_device_health_metrics'),
    ('015_add_pms_integration'),
    ('016_add_templates'),
    ('017_add_translations'),
    ('018_add_schedules'),
    ('019_add_widgets'),
    ('020_add_audit_logs')
