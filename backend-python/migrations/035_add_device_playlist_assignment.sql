...
-- Allows direct playlist assignment to individual devices
...
-- Add comment
COMMENT ON COLUMN devices.assigned_playlist_id IS 'Playlist directly assigned to this device (overrides tag-based assignment)';
