...
ARSAKA_TUTUR adalah sistem chat AI yang dapat di-attach ke berbagai project ARSAKA (MANTRA, PUGUH, PANDAWA, dll). Dibangun dengan arsitektur modular yang memudahkan penggantian komponen.
...
```bash
git clone https://github.com/your-org/arsaka-chat-ai.git
cd arsaka-chat-ai
cp .env.example .env
...
```bash
python scripts/seed_tenant.py --id=mantra --name="ARSAKA_MANTRA"
```
