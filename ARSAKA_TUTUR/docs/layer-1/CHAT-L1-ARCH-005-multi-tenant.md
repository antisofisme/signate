...
ARSAKA_TUTUR akan digunakan oleh multiple projects (tenants): MANTRA, PUGUH, PANDAWA, dll. Setiap tenant memiliki:
...
pandawa_config = TenantConfig(
    ...
    system_prompt="""You are a Hospitality Assistant for ARSAKA_PANDAWA.
