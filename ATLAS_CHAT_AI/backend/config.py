"""
Configuration management for ATLAS_CHAT_AI.
    ...
    def from_env(cls) -> "DatabaseConfig":
        ...
        if database_url:
            ...
            return cls(
                ...
                database=parsed.path.lstrip("/") if parsed.path else "atlas_chat",
        ...
        return cls(
            ...
            database=os.getenv("DB_NAME", "atlas_chat"),
...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            app_name=os.getenv("APP_NAME", "ATLAS_CHAT_AI"),
