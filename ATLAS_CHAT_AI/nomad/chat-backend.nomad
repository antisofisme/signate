# ATLAS_CHAT_AI Backend - Nomad Job Definition
...
job "chat-backend" {
  ...
  meta {
    version     = "1.0.0"
    description = "ATLAS Chat AI - RAG Chat with Memory"
  }
  ...
  group "api" {
    ...
    service {
      ...
      tags = [
        "traefik.enable=true",
        "traefik.http.routers.chat-api.rule=Host(`chat-api.atlashub.site`)",
    ...
    task "backend" {
      ...
      env {
        ...
        # CORS
        CORS_ORIGINS = "https://chat.atlashub.site,http://localhost:3003,http://31.97.111.175:3003"
...
DATABASE_URL=postgresql://chat_owner@[2a02:4780:59:ca9a::1]:5433/atlas_chat
