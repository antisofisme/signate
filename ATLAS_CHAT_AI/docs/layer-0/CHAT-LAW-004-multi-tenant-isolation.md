...
ATLAS_CHAT_AI adalah sistem reusable yang akan di-attach ke berbagai project:
- ATLAS_MANTRA (decisions)
- ATLAS_PUGUH (enforcement)
- ATLAS_PANDAWA (hospitality)
- Future projects
...
```python
# When attaching ATLAS_CHAT_AI to a project
