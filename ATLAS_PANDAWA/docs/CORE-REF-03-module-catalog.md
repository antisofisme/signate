...
This document is the **definitive inventory of all modules** in ATLAS_PANDAWA. It specifies each module's role, architectural classification, subscription model, and dependencies.
