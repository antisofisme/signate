...
This document defines the **formal event schema, naming conventions, versioning rules, and integrity requirements** for all events in ATLAS_PANDAWA. Event contracts are binding agreements between producers and consumers across modules and tenants.
