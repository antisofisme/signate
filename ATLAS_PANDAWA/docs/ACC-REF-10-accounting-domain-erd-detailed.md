...
This document provides the **detailed entity relationship design for the Accounting domain**. Accounting is the "financial spine" of ATLAS_PANDAWA—all other operational domains (PMS, POS, Inventory, Procurement, HR) must integrate with and conform to this accounting model.
