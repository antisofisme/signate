...
This document describes the **event-driven architectural pattern** that serves as the backbone for integration, observability, and audit across ATLAS_PANDAWA. Events are the primary mechanism for loose coupling between modules and tenants.
