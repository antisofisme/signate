...
This document specifies the **core operational workflow** of the Accounting module in ATLAS_PANDAWA. It defines the business process for invoice generation, payment recording, journal posting, reconciliation, and period closing (financial statement preparation).
