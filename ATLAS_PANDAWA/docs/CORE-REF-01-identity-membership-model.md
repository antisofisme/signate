...
This document defines the **foundational identity and access control model** for ATLAS_PANDAWA. It is the authoritative source for how users, tenants, roles, and permissions relate.
...
**What it is**: A complete, isolated business operating within ATLAS_PANDAWA.
