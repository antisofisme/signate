...
This document defines the **functional use cases and actors** for ATLAS_PANDAWA (Hospitality App Family). It establishes what each role can do in the system, serving as the foundation for detailed business process flows (BPMNs) and system design.
