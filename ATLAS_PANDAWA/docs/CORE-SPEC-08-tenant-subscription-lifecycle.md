...
This document specifies the **business process and state machine** for tenant and subscription lifecycle in ATLAS_PANDAWA. It defines how tenants are created, activated, managed, modified, suspended, and terminated.
