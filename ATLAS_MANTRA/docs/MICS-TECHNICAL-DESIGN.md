...
```json
{
  "task_context": {
    ...
    "checklist": [
      ...
      {"id": "build", "step": "Build Docker image", "command": "docker build -t atlas-mantra-api:v1.0.6 .", "blocking": true},
