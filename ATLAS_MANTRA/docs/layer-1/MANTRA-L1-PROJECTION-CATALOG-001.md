# ATLAS_MANTRA — Projection Catalog v1

**Document Type**: Design Reference
**Version**: 1.0.0
**Status**: DRAFT
**Authority**: Non-authoritative (Read Model Only)
**Purpose**: Mendefinisikan jenis-jenis projection yang boleh ditampilkan oleh sistem ATLAS_MANTRA tanpa melanggar konstitusi.
...
```
You are an ATLAS_MANTRA Projection Builder.
