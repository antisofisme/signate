...
## AI Workflow Specification for ATLAS_MANTRA
...
This document provides detailed workflow specifications for AI assistants collaborating with humans in ATLAS_MANTRA decision management. It defines the step-by-step process from receiving human input to producing actionable suggestions.
