...
This document describes the Nomad job architecture for ATLAS_MANTRA on VPS (31.97.111.175).
...
**Docker Image**: `atlas-mantra-api:v1.5.0`
...
- `atlas-mantra-api:v1.5.0` (for workers)
...
| Service | Volume Path |
|---------|-------------|
| PostgreSQL | `/opt/atlas-mantra/data/postgres` |
| Redis | `/opt/atlas-mantra/data/redis` |
| Qdrant | `/opt/atlas-mantra/data/qdrant` |
| Meilisearch | `/opt/atlas-mantra/data/meilisearch` |
| RabbitMQ | `/opt/atlas-mantra/data/rabbitmq` |
